  ...
  useEffect(() => {
    ...
    <ThemeProvider theme={theme}>
      ...
      <Grid xs={12} sx={{paddingBottom: "10px"}}> 
        <Typography variant="h4" component="div" sx={{flexGrow: 1, textAlign: "left", fontWeight: 800}}>주문 관리</Typography>
        <Typography component="div" sx={{flexGrow: 1, textAlign: "left", fontWeight: 500}}>가게의 주문을 관리합니다.</Typography>
      </Grid>
			<Grid xs={12} sx={{flexGrow: 1, height: "40%", paddingBottom: "10px"}}>
          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            ...
            <TableBody>
              {orders.map((order) => (
                ...
                >
                  <TableCell align="center" component="th" scope="row">{order.uid}</TableCell>
                  <TableCell align="center">{order.created_at}</TableCell>
                  <TableCell align="center">{order.total_price}원</TableCell>
