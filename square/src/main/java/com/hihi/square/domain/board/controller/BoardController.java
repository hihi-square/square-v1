...
public class BoardController {
	...
	public ResponseEntity getFreeBoard(Authentication authentication,@PathVariable("boardId") Integer boardId, @PathVariable("emdId") Integer emdId, @PathVariable("depth") Integer depth, @PathParam("query") String query){
